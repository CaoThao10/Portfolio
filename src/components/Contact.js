...
const Contact = () => {
  ...
  return (
    <div className="h-svh flex flex-col justify-center items-center">
      <div className="flex flex-col lg:justify-center lg:items-center w-[350px] lg:w-full">
        <div className="lg:grid lg:grid-cols-2 w-[350px] lg:w-[1000px] flex flex-col about-left-container pl-[1.5rem] lg:pl-0 ">
          <div
            data-aos="fade-right"
            data-aos-offset="300"
            data-aos-easing="ease-in-sine"
